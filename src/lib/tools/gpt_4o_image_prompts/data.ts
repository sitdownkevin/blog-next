...
export const imageData: BoxProps[] = [ // Use the imported type
    {
        ...
        inputImgPath: "/figures/gpt_4o_image/input/nh14stYm4o0W2Rbb3rAIjIy8kpAyN0.webp",
        outputImgPath: "/figures/gpt_4o_image/output/YRUN9gdh3Kh80ScuU3HJyCBPOooRGR.webp",
        tags: ["可爱", "珐琅徽章", "金属光泽", "鲜艳色彩", "方形", "白色背景"],
    },
    {
        title: "吉卜力风",
        prompt: "吉卜力化这张图片",
        inputImgPath: "/figures/gpt_4o_image/input/tE7hIxm5c1xyzmKdQIEZvUQuPNjXDB.webp",
        outputImgPath: "/figures/gpt_4o_image/output/tE7hIxm5c1xyzmKdQIEZvUQuPNjXDB.webp",
        tags: ["可爱", "吉卜力"],
    },
    {
        title: "卡纸风",
    ...
    },
    {
        ...
        inputImgPath: "/figures/gpt_4o_image/input/Kl5fZ5cC5E17upYotvhoMTCS0gxzRx.webp",
        outputImgPath: "/figures/gpt_4o_image/output/tE7hIxm5c1GeGmKdQIEZvUQuPNjXDB.webp",
...
风格：3D卡通Q版场景插画，1:1画幅，整体风格参考Pixar动画风，人物拥有夸张的大头比例，圆润的大眼睛、软萌的鼻子，脸上带有可爱的表情，整体质感光滑细腻，呈现出玩具般的柔软塑料感。背景为暗色纯色（如纯黑色），采用柔和棚拍光，没有明显阴影，风格干净、温暖、亲和，整体感觉超可爱、现代、数字插画感强烈`,
        inputImgPath: "/figures/gpt_4o_image/input/Kl5fZ5cC5E17upYotvhoMTCS0gxzRx.webp",
        outputImgPath: "/figures/gpt_4o_image/output/Su7Bc8kpPk6c5WTs16Vd4FVJB8VXdY.webp",
    ...
    },
    {
        ...
        inputImgPath: "/figures/gpt_4o_image/input/Kl5fZ5cC5E17upYotvhoMTCS0gxzRx.webp",
        outputImgPath: "/figures/gpt_4o_image/output/EHZ7UpqLfUkUewpRasKGcPJFv6ET2i.webp",
    ...
    },
    {
        ...
        prompt: "Turn the subject in the attached image into a kawaii enamel pin. Use glossy metal outlines and vibrant enamel fill. No extra added features. Square mockup format. White background.",
        inputImgPath: "/figures/gpt_4o_image/input/Kl5fZ5cC5E17upYotvhoMTCS0gxzRx.webp",
        outputImgPath: "/figures/gpt_4o_image/output/hgIYqEhmMcG0O2L5A8zvw3QgJspERg.webp",
