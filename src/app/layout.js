  ...
  return <>
    <div className="w-5/6 md:w-2/3 lg:w-1/2 flex flex-col space-y-8 mb-16">
      <div className="flex flex-row justify-center items-center space-x-4">
        <Image src={"/favicon-32x32.png"} width={16} height={16} alt="" className="rotate-slowly" />
      </div>
      ...
      <div className="flex flex-row justify-center space-x-8 md:space-x-16">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-gray-500 text-xxs">
            <Link href={'https://greasyfork.org/zh-CN/scripts/519430-tj-dorm-wifi-%E8%BE%85%E5%8A%A9'} target="_blank" rel="noopener noreferrer">TJ-DORM-WIFI</Link>
          </span>
          <span className="text-gray-500 text-xxs">
            <Link href={'https://github.com/sitdownkevin/Simple-Robotic-Hand-Control'} target="_blank" rel="noopener noreferrer">S-R-H-C</Link>
          </span>
        </div>
      </div>
    </div>
    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="min-w-[320px] flex flex-col items-center justify-center w-full">
          <Header />
          <div className="w-5/6 md:w-2/3 lg:w-1/2 mb-16">
            {children}
          </div>
          <Bottom />
        </div>
