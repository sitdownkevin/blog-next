    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-row justify-between">
                ...
                <span className="text-xs font-bold text-amber-600 dark:text-amber-400">{educationElement.school}</span>
...
export default function EducationElementsCard({ educationElements }: EducationElementsCardProps) {
    return (
        <div className="mt-2"> {/* Add some margin top for separation */}
