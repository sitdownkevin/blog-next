...
export default function MenubarClient({ components }: MenubarClientProps) {
      ...
      return (
        ...
        >
          ...
          {activeDropdown === component.title && (
            <div className="absolute top-full left-0 bg-popover rounded-md min-w-[150px] z-10 shadow-md dark:shadow-gray-800">
              {" "}
  ...
  return (
    <nav className="flex flex-row items-center gap-1 sm:gap-2 justify-center bg-background">
      {" "}
