...
function ProjectExperienceElementCard({ projectExperienceElement }: ProjectExperienceElementCardProps) {
    return (
...
export default function ProjectExperienceElementsCard({ projectExperienceElements }: ProjectExperienceElementsCardProps) {
    return (
